...
""",
        ...
        self.assertIn(
            "Interactive component 'comp1' must be in focus_order", results[0].message
        )
...
""",
        ...
        self.assertEqual(results[0].code, "H002")
        self.assertIn(
            "Interactive component 'comp1' found but no focus_order defined",
            results[0].message,
        )
