from mono_designer.models.screen import ScreenSpec
    ...
    data = {
        ...
        "components": [
            ...
            },
            {
                ...
                "type": "table",
                "region": "region_b",
                "purpose": "service status list",
            },
        ],
        "focus": {"default_target": "service-table", "focus_order": ["service-table"]},
        "footer_keys": [
